...
const CreatorCard = ({ rank, creatorImage, creatorName, creatorETH }) => {
  ...
  return (
    <div
      className="min-w-190 minlg:min-w-240 dark:bg-nft-black-3 bg-white border dark:border-nft-black-3
    ...
    >
      <div className="w-8 h-8 minlg:w-10 minlg:h-10 bg-nft-red-violet flexCenter rounded-full ">
        <p className="font-poppins dark:text-nft-black-1 text-white font-semibold text-base minlg:text-lg">
          {rank}
        </p>
      </div>
      <div className="my-2 flex justify-center">
        <div className="relative w-20 h-20 minlg:w-28 minlg:h-28">
          ...
          />
          <div className="absolute w-5 h-5 minlg:w-8 minlg:h-8 bottom-2 -right-0">
            <Image
              src={images.tick}
              layout="fill"
              objectFit="contain"
      ...
      <div className="mt-3 minlg:mt-7 text-center flex-center flex-col">
